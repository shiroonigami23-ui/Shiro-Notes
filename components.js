...
// [NEW] Toolbar for the Rich Text Editor
...
// [NEW] The Rich Text Editor component
...
// Editor component is updated to use the RichTextEditor
function Editor({ activeNote, onUpdate, onDelete, onToggleLock, hasPassword }) {
    ...
    const editorKey = activeNote ? activeNote.id : 'no-note';
    ...
    return (
        <div className="flex flex-col h-full">
            <div className="flex items-center mb-4">
                ...
                {hasPassword && (
                    <button onClick={onToggleLock} className="ml-4 p-2 text-gray-500 hover:text-blue-500 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors" title={activeNote.isLocked ? "Unlock Note" : "Lock Note"}>
                        {activeNote.isLocked ? 
